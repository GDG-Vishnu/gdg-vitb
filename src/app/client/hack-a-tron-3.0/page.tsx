...
const HackATron3Page = () => {
  ...
  const hackathonDetails = {
    ...
    subtitle: "A Harry Potter-themed 24Hours Hackathon",
      ...
      <section className="relative pt-20 pb-20 px-4">
        <div className="max-w-7xl w-full mx-auto">
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row gap-4 justify-center items-center rounded-2xl"
          >
            <button
            ...
            >
              {isRegistered ? (
                ...
                <>
                  Register Now
                  <div className="flex items-center bg-stone-900 w-[40px] h-[40px] ml-2 rounded-full justify-center">
                    <Image
