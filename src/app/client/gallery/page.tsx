...
import { Camera, Image as ImageIcon, Sparkles, Users, Star } from "lucide-react";
...
function Gallery() {
  ...
  const coverImageUrl = "https://res.cloudinary.com/dlupkibvq/image/upload/v1767175693/f7gerxglae9pomxppanb.png";
    ...
    >
      ...
      <div className="relative">
        ...
        <div className="text-center py-12 px-4 relative">
          {/* Decorative Stars */}
          <Star className="absolute top-8 left-1/4 w-6 h-6 text-yellow-400 animate-pulse" fill="currentColor" />
          <Star className="absolute top-12 right-1/4 w-8 h-8 text-blue-400 animate-pulse" fill="currentColor" style={{ animationDelay: '0.5s' }} />
          <Sparkles className="absolute top-16 left-1/3 w-7 h-7 text-green-400 animate-pulse" style={{ animationDelay: '1s' }} />
          <Sparkles className="absolute top-20 right-1/3 w-6 h-6 text-red-400 animate-pulse" style={{ animationDelay: '1.5s' }} />
        ...
        <div className="max-w-7xl mx-auto px-4 mb-12 relative">
          ...
          <div className="relative w-full h-[50vh] md:h-[60vh] overflow-hidden rounded-3xl shadow-2xl border-4 border-white">
            <Image
              src={coverImageUrl}
