                ...
                <Checkbox
                  ...
                  onCheckedChange={(checked) => {
                    ...
                    if (checked) {
                      ...
                      onChange(currentValue.filter((v: unknown) => v !== option));
                    }
                  }}
                  className="mt-1"
                />
        ...
        return (
          <div className="space-y-4">
            ...
            <div className="min-h-[3rem] p-3 border-2 border-gray-200 rounded-lg bg-gray-50">
              {(value || []).length > 0 ? (
                <div className="flex flex-wrap gap-2">
                  {(value || []).map((selectedValue: unknown, index: number) => (
                    <Badge
                      key={index}
                      variant="secondary"
            ...
            <div className="space-y-3 max-h-48 overflow-y-auto">
              ...
              {multiSelectOptions.map((option: unknown, index: number) => (
                <div key={index} className="flex items-start space-x-3">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => {
                      ...
                      if (checked) {
                        ...
                        onChange(
                          currentValue.filter((v: unknown) => v !== optionValue)
                        );
                      }
                    }}
                    className="mt-1"
